...
void setup()
{
  ...
  textAlign(RIGHT, TOP);
  textSize(21);
  text_pointDispersion_X = 600 * width/640;
  text_pointDispersion_Y = 48 * height/832; 
  text_line_Y = (80 * text_pointDispersion_Y)/48;
  text_displayAxis_Y = (112 * text_pointDispersion_Y)/48;
  text_strokeWeight_X = text_pointDispersion_X - (2.25 * textWidth("Point Dispersion"));
  text_strokeWeightValue_X = text_pointDispersion_X - (1.35 * textWidth("Point Dispersion"));
  
  checkBox_pointDispersion_X = (605 * text_pointDispersion_X)/600;
  checkBox_pointDispersion_Y = (50 * text_pointDispersion_Y)/48;
  checkBox_line_Y = (82 * text_line_Y)/80; 
  checkBox_displayAxis_Y = (114 * text_displayAxis_Y)/112; 
  ...
  sliderDimensions = text_strokeWeightValue_X - slider_strokeWeight_X;
  strokeWeight_max = 10;
...
void optionsDisplay()
{
  ...
  rect(checkBox_pointDispersion_X, checkBox_displayAxis_Y, checkBox_dimensions, checkBox_dimensions, 5);
  ...
  text("Display Axis", text_pointDispersion_X, text_displayAxis_Y);
